...
## Exercise
We're going to create this plot:
![](./figs/Tuberculosis.png)

## Exercise
From the data in `PRAC_HOME/data/tb_who.csv`.

starter code:
```{r, eval=FALSE}
tb_cases <- readr::read_csv(file.path(COURSE_HOME,"data/tb_who.csv"))
View(tb_cases)
```
...
* How does the tidied data facilitate plotting?
