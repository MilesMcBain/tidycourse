...
## Datasets
Let's familise ourselves with the data our examples will work on:
```{r}
mtcars
airquality
```
...
## An Aside on ggplot2
* This course is not a `ggplot2` course.

##Delving Further into dplyr
* Each `mutate` and `summarise` conditional versions to make large scale wrangling possible.
