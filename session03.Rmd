...
On problem is that `dependent_packs` contains packages in the Tidyverse. For example most `tidyverse` packages have a dependency on `tibble`. 
...
For some a great collection of examples see: [https://jennybc.github.io/purrr-tutorial/index.html](https://jennybc.github.io/purrr-tutorial/index.html)
